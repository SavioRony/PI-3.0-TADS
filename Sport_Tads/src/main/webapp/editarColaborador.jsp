...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="text-align: center; margin-top: 50px; margin-bottom: 50px">Editar Dados do Colaborador</h1>
            <form action="CadastrarCliente" method="POST">
                <div class="row">
                    ...
                    <div class="form-group col-lg-4">
                        <p>CPF</p>
                        <input name="cpf" class="form-control" disabled="true" required="true"/><br/>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-lg-8">
                        <p>Email</p>
                        <input name="email" class="form-control" disabled="true" required="true"/><br/>
                    </div>
                    <div class="form-group col-lg-4">
                        <p>Senha</p>
                        <input name="senha" class="form-control" disabled="true" required="true"/><br/>
                    </div>
                </div>
