...
<html>
    ...
    <body>
        ...
        <div class="container">
                ...
                <tbody> 
                    <c:forEach var="produto" items="${listaProd}">
                        <tr class="table-light">
                            ...
                            <td>
                                <a href="<c:url value="/AlterarProduto?codProduto=${produto.codProduto}"/>">
            ...
            <br/>
            <a href="protegido/Backoffice/cadastrarProduto.jsp"><button type="button" class="btn btn-primary" style="float: right">Novo Produto</button></a>
        </div>
    </body>
</html>