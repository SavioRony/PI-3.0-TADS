<%-- 
    ...
    Created on : 28/10/2020, 00:14:27
    Author     : Fernando
--%>
    ...
    <body class="container">
        ...
        <table class="table">
            <thead class="thead-light" >
                ...
                <th style="text-align: center">Nome da filial</th>
            ...
            <tbody> 
                <c:forEach var="filial" items="${listaFiliais}">
                    <tr>
                        ...
                        <td style="text-align: center">${filial.codFilial}</td>
                        <td style="text-align: center">${filial.nomeFilial}</td>
                        <td style="text-align: center">${filial.estado}</td>
                        <td style="text-align: center">${filial.cidade}</td>
                        <td style="text-align: center">${filial.status}</td>
                                      
                       
                        
                        <td style="text-align: center"><a href="AlterarFilial?codFilial=${filial.codFilial}"><button class="btn btn-default">
        ...
        <a href="incluirFilial.jsp" ><button type="button" class="btn btn-primary" style="float: right">Cadastrar Filial  </button></a>
