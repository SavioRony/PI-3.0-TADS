...
<html>
    ...
    <script lang="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btn-novo-produto").click(function () {
                window.location.href = "cadastrarProduto.jsp";
            });
    ...
    <body>
        ...
        <div class="container">
            <h1 style="text-align: center; margin-top: 50px; margin-bottom: 50px">Lista de Produtos</h1>
            <table class="table">
            ...
            <br>
            <button type="button" class="btn btn-primary" id="btn-novo-produto" style="float: right">Novo Produto</button>
        </div>
    </body>
</html>